#
[![TypingSVG](https://readme-typing-svg.demolab.com?font=Exo+2&size=34&duration=2000&pause=800&width=1080&lines=Hello,+World!;I'm++theAstralProgrammer0;BSc.+Electrical+Electronics+Engineering;Welcome+to+My+World;I+Love+Linux+Operating+Systems+...;Mathematics;Physics;Philosophy;Psychology;Music;and+Spacetime;I+Have+Mastered+The+Following+Languages...;C;Rust;Go;C%23;C%2B%2B;Assembly;Bash+Scripting;HTML;CSS;JavaScript;TypeScript;Python;SQL;and+Solidity;Libraries+And+Frameworks+I've+Explored;ASP.NET+Core;Bootstrap;JQuery;React.js;Vue.js;Next.js;Express.js;Django;Flask;Jinja;MongoDB;Docker;Puppet;SQL+Alchemy;Mongoose+ORM;Hardhat;I+Use+These+Tools+For+...;Frontend+Engineering;Backend+Engineering;DevOps+Engineering;Blockchain+Development;Web+Stack+Debugging;Web+App+Optimization;Database+Administration;Network+Administration;Systems+Programming;and+Problem+Solving+with+DSA;Some+Of+My+Soft+Skills+Are+...;Leading+Self;Leading+Others;Problem+Solving;Communication+For+Impact;Managing+Complex+Tasks;Critical+Thinking;and+Quantitative+Reasoning;...+to+name+a+few;My+Drive+Comes+From+My+Passion+For+Problem+Solving;I'm+A+Lifelong+Learner;and+I+Learn+By+Doing;Thank+YOU+for+your+Time+and+Attention)](https://git.io/typing-svg)
...
I'm a *Software Engineer and Full-Stack Developer*, driven by curiosity and a love of code.  
