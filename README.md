# [![TypingSVG](https://readme-typing-svg.demolab.com?font=Exo+2&size=34&duration=2000&pause=800&width=1080&lines=Hello,+World!;I'm+theAstralProgrammer0;You+Are+Welcome+To+My+World;I+Love+Computers+...;Music;Philosophy;Psychology;and+Space;Programming+And+Scripting+Languages+I've+Mastered...+Yet.;Bash;C;Assembly;HTML;CSS;JavaScript;Python;and+Ruby;Libraries+And+Frameworks+I've+Explored...+Yet.;React.js;Next.js;Express.js;Django;Flask;Ruby+on+Rails;FastAPI;Node.js;Redis;Docker;Kubernetes;Puppet;My+Tech+Skills+Include+...;Frontend+Engineering;Backend+Engineering;DevOps+Engineering;Web+Stack+Debugging;Web+App+Optimization;Database+Administration;Network+Administration;Systems+Programming;and+Problem+Solving+with+DSA;Some+Of+My+Soft+Skills+Are...;Leading+Self;Leading+Others;Problem+Solving;Communication+For+Impact;Managing+Complex+Tasks;Critical+Thinking;and+Quantitative+Reasoning;My+Drive+Comes+From+My+Passion+For+Problem+Solving;I'm+A+Lifelong+Learner;and+I+Learn+By+Doing;Thank+YOU+For+Your+Time+And+Attention)](https://git.io/typing-svg)
